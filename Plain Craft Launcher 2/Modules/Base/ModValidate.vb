...
Public Class ValidateFolderName
    ...
    Public Sub New()
    End Sub
    Public Sub New(Path As String, Optional UseMinecraftCharCheck As Boolean = True, Optional IgnoreFolderName As String = Nothing)
        Me.Path = Path
    ...
    Public Overrides Function Validate(Str As String) As String
        Try
            ...
            If Not SameNameCheck = "" Then
                '进行重命名相关的特判
                If IgnoreFolderName?.Equals(Str, StringComparison.OrdinalIgnoreCase) Then
                    If IgnoreFolderName.Equals(Str) Then
                        Return "请输入一个不同的名称！"
                    End If
                Else
